...
Static public-safe promo microsite for Faith Cheltenham's AI systems portfolio.

This repository/site is a promotional public surface. It does not include private engine source, credentials, adapters, prompts, rollback snapshots, signed URLs, customer data, or operational receipts.

## Pages

- [Faith Cheltenham AI Services And Projects](index.html)
- [Quote-First Offers](offers.html)
- [Pilot Sprint Menu](pilot-sprint-menu.html)
- [Buyer FAQ](buyer-faq.html)
- [Buyer Trust Matrix](buyer-trust-matrix.html)
